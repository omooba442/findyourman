...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../css?family=Playfair+Display%7COpen+Sans:400,600">
      ...
      <section class="section jumbotron-2">
          ...
          <div class="container">
            <div class="jumbotron-2-content-inner">
              <div class="row justify-content-start">
                <div class="col-xl-5">
                  <h1 class="text-white">Welcome To Findyourman.</h1>
                  <p class="text-white-8 text-m intro-subtitle ls-ng-1">At Find Your Man, we believe that love knows no boundaries. Our platform is designed specifically for women seeking meaningful connections with men, regardless of gender, location, religion, or relationship goals.</p>
                  <a class="button button-icon button-icon-left button-primary" href="https://findyourman.org/auth/friends">
                    <span class="icon mdi mdi-magnify"></span>Find Your Man
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="jumbotron-2-block">
          ...
          <div class="container mt-30 mt-md-45 mt-xxl-75 text-center">
            ...
            <p class="text-gray-700 wow fadeIn" data-wow-delay=".025s"><span style="max-width: 850px;">Our mission is simple: to empower women to take control of their dating lives and find the partners they truly desire. We understand that every individual has unique preferences and needs when it comes to love and companionship. That's why we’ve created a space where women can express themselves freely and connect with men who align with their values and aspirations.</span></p>
            <div class="row row-30 row-xl-50 mt-md-45 mt-xxl-70">
              <div class="col-sm-6 col-lg-4">
                <!-- Tour 3-->
                <article class="tour-3 bg-image context-dark wow fadeIn" style="background-image: url(images/D23.png);">
                  <div class="tour-3-inner">
                    <div class="tour-3-main">
                      <h3 class="tour-3-title"><a href="https://findyourman.org/auth/find-matches">John Wilson</a></h3>
              ...
              <div class="col-sm-6 col-lg-4">
                <!-- Tour 3-->
                <article class="tour-3 bg-image context-dark wow fadeIn" style="background-image: url(images/D13.png);" data-wow-delay=".1s">
                  <div class="tour-3-inner">
                    <div class="tour-3-main">
                      <h3 class="tour-3-title"><a href="https://findyourman.org/auth/find-matches">Jane Peterson</a></h3>
                      <ul class="tour-3-meta">
                        <li><span class="icon mdi material-design-clock100"></span><span>active 10 days ago</span></li>
                      </ul>
                    </div>
              ...
              <div class="col-sm-6 col-lg-4">
                <!-- Tour 3-->
                <article class="tour-3 bg-image context-dark wow fadeIn" style="background-image: url(images/D47.png);" data-wow-delay=".2s">
                  <div class="tour-3-inner">
                    <div class="tour-3-main">
                      <h3 class="tour-3-title"><a href="https://findyourman.org/auth/find-matches">Emma Smith</a></h3>
                      <ul class="tour-3-meta">
              ...
              <div class="col-sm-6 col-lg-4">
                <!-- Tour 3-->
                <article class="tour-3 bg-image context-dark wow fadeIn" style="background-image: url(images/D25.png);" data-wow-delay=".3s">
                  <div class="tour-3-inner">
                    <div class="tour-3-main">
                      <h3 class="tour-3-title"><a href="https://findyourman.org/auth/find-matches">Kate McMillan</a></h3>
                      <ul class="tour-3-meta">
              ...
              <div class="col-sm-6 col-lg-4">
                <!-- Tour 3-->
                <article class="tour-3 bg-image context-dark wow fadeIn" style="background-image: url(images/visitor-5-370x417.jpg);" data-wow-delay=".4s">
                  <div class="tour-3-inner">
                    <div class="tour-3-main">
                      <h3 class="tour-3-title"><a href="https://findyourman.org/auth/find-matches">Eric Cobb</a></h3>
                      <ul class="tour-3-meta">
              ...
              <div class="col-sm-6 col-lg-4">
                <!-- Tour 3-->
                <article class="tour-3 bg-image context-dark wow fadeIn" style="background-image: url(images/D50.png);" data-wow-delay=".5s">
                  <div class="tour-3-inner">
                    <div class="tour-3-main">
                      <h3 class="tour-3-title"><a href="https://findyourman.org/auth/find-matches">Mary Ross</a></h3>
                      <ul class="tour-3-meta">
              ...
              <div class="col-12 wow fadeIn text-center" data-wow-delay=".6s"><a class="button button-sm button-gray-outline wow fadeIn" href="https://findyourman.org/auth/find-matches" data-wow-delay=".07s">Find Matches</a></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="range">
          <div class="cell-lg-7 cell-xl-8 cell-xxl-9">
            <div class="cell-inner section-lg text-center text-sm-left">
              <h2 class="text-center text-xl-left wow fadeIn">Why Choose Findyourman</h2>
              ...
              <div class="owl-carousel owl-1 list-group-1 mt-lg-50" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="2" data-xl-items="3" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="30" data-mouse-drag="false">
                <article class="lg-1-item wow fadeIn">
                  ...
                  <div class="lg-1-item-main">
                    <h3 class="lg-1-item-title font-weight-normal"><span class="lg-1-item-counter"></span>Tailored Matching</h3>
                    <p>Our advanced algorithms consider various factors such as location, interests, relationship goals, and more to provide you with personalized matches that resonate with your desires.</p>
                  </div>
                </article>
                <article class="lg-1-item wow fadeIn" data-wow-delay=".025s">
                  <div class="icon lg-1-item-icon mdi material-design-compass106"></div>
                  <div class="lg-1-item-main">
                    <h3 class="lg-1-item-title font-weight-normal"><span class="lg-1-item-counter"></span>Inclusivity</h3>
                    <p> We celebrate diversity and welcome women of all backgrounds, beliefs, and orientations. Our platform is designed to create an inclusive community where everyone can find love.</p>
                  </div>
                </article>
                <article class="lg-1-item wow fadeIn" data-wow-delay=".05s">
                  <div class="icon lg-1-item-icon mdi mdi-comment-processing"></div>
                  <div class="lg-1-item-main">
                    <h3 class="lg-1-item-title font-weight-normal"><span class="lg-1-item-counter"></span>Safety And Privacy</h3>
                    <p>Your safety is our top priority. We implement strict security measures to protect your personal information and ensure a safe online environment for all users.</p>
                  </div>
                </article>
              </div>
            </div>
          ...
          <div class="container">
            <div class="row row-30 justify-content-lg-between">
              <div class="col-sm-5 col-md-3 col-lg-3">
                <h3 class="footer-modern-title">Quick links</h3>
              ...
              <div class="col-sm-7 col-md-5 col-lg-4">
                ...
                <div class="footer-modern-item-block" style="max-width: 300px;">
                  <div class="row row-13">
                    <div class="col-6">
                      <ul class="list list-1">
                        <li><a href="https://findyourman.org/auth/login">Turkey</a></li>
                        <li><a href="https://findyourman.org/auth/login">Greece</a></li>
                        <li><a href="https://findyourman.org/auth/login">Italy</a></li>
                        
                      </ul>
                    </div>
                    <div class="col-6">
                      <ul class="list list-1">
                        <li><a href="https://findyourman.org/auth/login">England</a></li>
                        <li><a href="https://findyourman.org/auth/login">New Zealand</a></li>
                        <li><a href="https://findyourman.org/auth/login">India</a></li>
        ...
        <div class="footer-modern-aside">
          <div class="container">
            <div class="row row-30">
              ...
              <div class="col-lg-4 d-flex flex-column align-items-center text-center order-2 order-lg-3"><a class="button btn-sm small button-default-outline wow fadeIn" href="https://findyourman.org/auth/login" data-wow-delay=".07s">Join Now</a></div>
            </div>
          </div>
        </div>
      </footer>
